      ...
      <div class="normal-player" v-show="fullScreen" ref="normalPlayer">
        ...
        <div class="middle" @touchstart.prevent="middleTouchStart" @touchmove.prevent="middleTouchMove" @touchend.prevent="middleTouchEnd">
          <div class="middle-l" ref="middleL">
            ...
            <div class="playing-lyric-wrapperr">
        ...
        <div class="bottom">
          ...
          <div class="progress-wrapper">
            ...
            <span class="timer timer-r">{{format(currentSong.duration)}}</span>  
          </div>
          <div class="operators">
...
export default {
    ...
    methods: { 
      ...
      format(interval) {
        ...
        const second = this.pad(Math.floor(interval % 60));
      ...
      getPosAndscale() {
        ...
        const x = -(width.innerWidth / 2 - paddingLeft);
    ...
    watch: {
      ...
      playing(newPlayig) {
        this.$nextTick(() => {   
          ...
          newPlayig ? audio.play() : audio.pause();
        })
      }
    },
    components: {
